...
/// Menu-bar extra: one gauge + percent. Color follows Stats utilization zones
/// (systemBlue ≤60%, orange ≤80%, red above).
...
struct ChipLabel: View {
    ...
    /// Stats `Double.usageColor` defaults: zones (0.6, 0.8), not reversed.
